...
ActiveRecord::Schema.define(:version => 20120522152324) do

  create_table "master_prices", :force => true do |t|
    t.string   "option"
  ...
  add_index "spree_suppliers_taxons", ["supplier_id"], :name => "index_suppliers_taxons_on_supplier_id"
  add_index "spree_suppliers_taxons", ["taxon_id"], :name => "index_suppliers_taxons_on_taxon_id"
